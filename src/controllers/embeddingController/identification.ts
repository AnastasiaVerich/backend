...
import {getFaceEmbeddingByUserId} from "../../models/embedding/embeddingModel";
...
export const identification = async (
    ...
    try {
        ...
        const isBlockUser = await checkExistBlockUser(userId, null);
        const isOperator = await checkOperatorExists(userId, null, null);
